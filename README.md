...
- **TRACK** – NFC/QR check-ins for real-time attendance and location logging.
- **LEARN & GROW** – Unlock personalized modules; progress is stored as a lifelong learning record linked to the student’s verified identity.
- **REWARD & EMPOWER** – Earn **XPPoints** for completed milestones, redeemable for subsidies at partnered vendors without paperwork.
...
## 🛠️ Tech & Tools  
- **Backend**: Secure API integration with Smart ID, data encryption, offline-first architecture.
- **Frontend**: Progressive Web App (PWA) for offline use, accessible UI for low-literacy and disabled users.
- **Database**: Real-time dashboards for teachers and admins with data visualization.
- **Hardware Prototype**: Solar-powered device with thumbprint authentication and NFC/QR support.
...
## 📌 Key Features  
✅ **Offline-first** – Works without internet in rural areas  
✅ **Smart ID integration** – Secure, verifiable identity linking  
✅ **Real-time tracking** – Attendance, location, progress monitoring  
✅ **Automated welfare distribution** – Convert learning milestones to subsidies  
...
2. **Lifelong Learning Ledger** – Dynamic, portable record of skills and achievements.  
3. **Automated Welfare** – Reduces bureaucracy, builds trust, and ensures support reaches those who need it.

---

## 📄 License  
This project is developed for the **GODAM Lahl 2.0 Smart ID Hackathon** and is open for educational and non-commercial use.
